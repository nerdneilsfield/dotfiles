...
# Using Callback Groups — ROS 2 Documentation: Jazzy  documentation
...
about the concept of executors.
...
the client always gets a response and prints `Receivedresponse`.
