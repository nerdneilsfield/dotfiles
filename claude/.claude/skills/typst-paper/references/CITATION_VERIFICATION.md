...
- [Typst-Specific: Hayagriva Format](#typst-specific-hayagriva-format)
...
When verifying citations for Typst, the same 6-step workflow applies. The only difference is the bibliography format (`.yml` vs `.bib`).
