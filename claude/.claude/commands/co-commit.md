---
description: 分析变更，自动拆分为多个 Conventional Commits 提交
allowed-tools: Bash(git add:*), Bash(git diff:*), Bash(git status:*), Bash(git log:*), Bash(git commit:*), Bash(git reset:*)
argument-hint: "[可选的 scope 或摘要提示]"
---
