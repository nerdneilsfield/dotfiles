...
if (Get-Command eza -ErrorAction SilentlyContinue)
{
    ...
    function el
    { eza -l --all --group-directories-first --git @args 
    }
    function ell
    { eza -l --all --all --group-directories-first --git @args 
    }
    function elt
    { eza -T --git-ignore --level=2 --group-directories-first @args 
    }
    function ellt
    { eza -lT --git-ignore --level=2 --group-directories-first @args 
    }
    function elT
    { eza -T --git-ignore --level=4 --group-directories-first @args 
    }
} elseif (Get-Command exa -ErrorAction SilentlyContinue)
{
    ...
    function el
    { exa -l --all --group-directories-first --git @args 
    }
    function ell
    { exa -l --all --all --group-directories-first --git @args 
    }
    function elt
    { exa -T --git-ignore --level=2 --group-directories-first @args 
    }
    function ellt
    { exa -lT --git-ignore --level=2 --group-directories-first @args 
    }
    function elT
    { exa -T --git-ignore --level=4 --group-directories-first @args 
    }
}
...
function setpx
{
    ...
    $env:all_proxy = $local_proxy
    $env:ftp_proxy = $local_proxy
    $env:socks_proxy = $local_proxy
    $env:socks5_proxy = $local_proxy
...
function unsetpx
{
    ...
    Remove-Item -Path Env:socks_proxy
    Remove-Item -Path Env:socks5_proxy
    Remove-Item -Path Env:no_proxy
}
