...
install_wasmtime_proxy() {
    ...
    green_echo "======================================"
    local _WASMTIME_VERSION=$(GetLatestReleaseWithRetryProxy "bytecodealliance/wasmtime")
    local _arch=$(uname -m)
...
install_wasmtime() {
    ...
    green_echo "======================================"
    local _WASM_VERSION=$(GetLatestReleaseWithRetryProxy "bytecodealliance/wasmtime")
    local _arch=$(uname -m)
    #   if [[ $_arch == "x86_64" ]]; then
    #     _arch="amd64"
    #   fi
